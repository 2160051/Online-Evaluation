...
INSERT INTO `form` VALUES (1,'Web Technology Peer Eval Prelims','This is the peer evaluation form for Web Technology Prelims','2018-01-28','form');
...
CREATE TABLE `group_form` (
  ...
  CONSTRAINT `formID` FOREIGN KEY (`formID`) REFERENCES `form` (`formID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `user_course` VALUES (1,1,'9358A',NULL);
...
-- Dump completed on 2018-06-05 11:55:33
